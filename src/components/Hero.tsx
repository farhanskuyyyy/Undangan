...
export const Hero = ({ groomName, brideName, weddingDate }: HeroProps) => {
  ...
  return (
    <div className="h-screen max-h-screen flex flex-col items-center justify-between text-center px-6 pt-10 pb-12 relative overflow-hidden">
      <motion.div
      ...
      >
        <div className="flex-none">
          <p className="text-sage tracking-[0.4em] uppercase mb-4 md:mb-6 text-[10px] md:text-xs font-light">The Wedding of</p>
          ...
          <div className="relative mb-6 md:mb-10">
            <motion.h1 
              ...
              className="text-5xl md:text-8xl font-serif text-sage italic leading-tight"
            >
              {groomName} <span className="inline-block mx-2 text-2xl md:text-5xl text-terracotta/60 font-sans not-italic">&</span> {brideName}
            </motion.h1>
          </div>
        </div>
        ...
        <div className="flex-grow flex items-center justify-center relative min-h-0">
          <div className="flex justify-center items-center -space-x-12 md:-space-x-20 relative scale-[0.85] md:scale-100 transition-transform duration-500">
            ...
            >
              <div className="w-44 h-64 md:w-[22rem] md:h-[30rem] overflow-visible">
            ...
            <motion.div
              ...
              className="relative z-20 -mt-10 md:-mt-20"
            >
              <div className="w-44 h-64 md:w-[22rem] md:h-[30rem] overflow-visible">
        ...
        <div className="flex-none pt-6 md:pt-10">
          <div className="w-24 h-px bg-terracotta/20 mx-auto mb-6"></div>
          ...
          >
            <p className="text-lg md:text-2xl font-serif text-sage mb-2 italic">{formattedDate}</p>
            <div className="flex items-center justify-center gap-4 text-gray-500 uppercase tracking-[0.2em] text-[10px] md:text-xs font-light">
              <span>Jakarta</span>
