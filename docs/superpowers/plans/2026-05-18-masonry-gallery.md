...
**Goal:** Create a responsive masonry gallery component using Tailwind CSS and Framer Motion.

**Architecture:** A standalone React component that uses Tailwind's `columns` utility for a masonry layout and Framer Motion for scroll-triggered entrance animations.

**Tech Stack:** React, Tailwind CSS, Framer Motion.

---

### Task 1: Create Gallery Component

**Files:**
- Create: `src/components/Gallery.tsx`

- [ ] **Step 1: Write the component with Masonry layout**
